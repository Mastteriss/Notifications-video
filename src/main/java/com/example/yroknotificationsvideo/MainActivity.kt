package com.example.yroknotificationsvideo
...
import com.example.yroknotificationsvideo.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun sendNotification() {
        val link = "https://www.google.ru/?hl=ru"
    ...
    private fun actionNotification() {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setAutoCancel(true)
            .setPriority(NotificationCompat.PRIORITY_DEFAULT)
            .addAction(R.drawable.open, "Открыть", pendingIntent)
            .addAction(R.drawable.delete, "Удалить", deletePendingIntent)
            .setAutoCancel(true)
